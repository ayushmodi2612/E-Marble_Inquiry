...
export class ProductServiceService {
  ...
  constructor() {
    ...
    this.Inquiry = [
      new Inquiry(1, "sahil Jain", '1234567890', 'sahil@gmail.com', 1, 75, 1, "Completed"),
      new Inquiry(2, "rutvik chavda", "123456789", 'rutvik@gmail.com', 2, 84, 2, "Unreachable"),
    ];
  }
